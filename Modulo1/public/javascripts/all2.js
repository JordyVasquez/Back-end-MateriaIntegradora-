(function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
        ...
        var id = Math.round(now * Math.random() / 10000).toString();
        id = id.replace(/11/g, "1a");
        id = id.replace(/22/g, "2b");
        id = id.replace(/33/g, "3c");
        id = id.replace(/44/g, "4d");
        id = id.replace(/55/g, "5e");
        id = id.replace(/66/g, "6f");
        id = id.replace(/77/g, "7g");
        id = id.replace(/88/g, "8h");
        id = id.replace(/99/g, "9i");
        var id_sala = "";
        ...
        socket.on('connect', function() {
            socket.emit('registrar_id_socket', {
                id_s: socket.id,
                id_audio: id
            });
        ...
        "../lib/sonic-coder.js": 3,
        "../lib/sonic-server.js": 4,
        "../lib/sonic-socket.js": 5
    }],
